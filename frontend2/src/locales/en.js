export default {
  ...
  bidCreate: {
    ...
    deliverableCategories: {
      preliminaryPlanning: 'Preliminary Planning',
  ...
  projectDetailArchitect: {
    ...
    bidNotSelectedDesc:
      'The client chose another architect for this project. Your bid stays here for your records.',
  ...
  projectWorkspace: {
    ...
    revisionEachRequired: 'Add a comment for every deliverable you marked.',
    revisionPooledHint: 'All {n} will be sent back together and cost a single revision round.',
    revisionRoundLabel: 'Revision {n}',
    deliverableRevisionRequested: 'Revision requested',
    reviseCta: 'Revise',
    reviseUndoCta: 'Undo',
    reviseFromTableHint: 'Need changes? Mark the deliverables below with Revise.',
    revisionBasketTitle: 'Deliverables to revise',
    revisionBasketHint: 'Tell the architect what needs to change on each one.',
    revisionCommentLabel: 'Comment',
    revisionSubmitCta: 'Send revision request',
    revisionConfirmTitle: 'This uses one revision round',
    revisionConfirmWarning:
      'Sending this consumes 1 of {max} revisions for this phase. {left} will remain.',
    revisionConfirmSubmit: 'Yes, request revision',
    ...
    progressByPhaseTitle: 'Progress by phase',
    targetFinishLabel: 'Target finish {date}',
    keyDatesTitle: 'Key dates',
    eventPhaseStarted: 'Phase {n} started',
    eventPhaseDelivered: 'Phase {n} submitted by architect',
    eventPhaseApproved: 'Phase {n} approved by client',
    eventPhaseEstimated: 'Phase {n} estimated finish',
    noKeyDatesYet: 'No dated milestones yet',
    noPhasesYet: 'No phases yet',
    openDeliverablesLink: 'Open deliverables',
    approveEachDesc:
    ...
    disbursedToYouLabel: 'Disbursed to you',
    heldInEscrowLabel: 'Held in escrow',
    notYetFundedLabel: 'Not yet funded',
    createInvoiceInContract: 'Create the invoice in Contract & Payment',
    payInContract: 'Pay in Contract & Payment',
    payoutInContract: 'Request the payout in Contract & Payment',
    deliverablesAwaitingTitle: '{n} deliverable(s) awaiting your decision',
    reviewDeliverablesCta: 'Review deliverables',
    deliverablesUploadedCount: '{done} of {total} deliverables uploaded',
    uploadAtLeastOne: 'Upload at least one deliverable before submitting',
    deliverablesMissingCount: '{n} deliverable(s) not uploaded yet',
    notSubmittedYet: 'Uploaded, but not submitted \u2014 the client cannot review it yet',
    reuploadCta: 'Upload again'
  },
  architectDashboard: {
    welcome: 'Welcome',
