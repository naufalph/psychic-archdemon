export default {
  ...
  bidCreate: {
    ...
    deliverableCategories: {
      preliminaryPlanning: 'Perencanaan Awal',
  ...
  projectDetailArchitect: {
    ...
    bidNotSelectedDesc:
      'Klien memilih arsitek lain untuk proyek ini. Penawaran Anda tetap tersimpan sebagai arsip.',
  ...
  projectWorkspace: {
    ...
    revisionEachRequired: 'Isi komentar untuk setiap deliverable yang Anda tandai.',
    revisionPooledHint: 'Semua {n} dikirim bersamaan dan hanya memakai satu jatah revisi.',
    revisionRoundLabel: 'Revisi {n}',
    deliverableRevisionRequested: 'Perlu revisi',
    reviseCta: 'Revisi',
    reviseUndoCta: 'Batal',
    reviseFromTableHint: 'Perlu perubahan? Tandai deliverable di bawah dengan Revisi.',
    revisionBasketTitle: 'Deliverable yang perlu direvisi',
    revisionBasketHint: 'Jelaskan ke arsitek apa yang harus diubah pada masing-masing.',
    revisionCommentLabel: 'Komentar',
    revisionSubmitCta: 'Kirim permintaan revisi',
    revisionConfirmTitle: 'Ini memakai satu jatah revisi',
    revisionConfirmWarning: 'Mengirim ini memakai 1 dari {max} revisi untuk fase ini. Sisa {left}.',
    revisionConfirmSubmit: 'Ya, minta revisi',
    ...
    currentPhaseLabel: 'Fase berjalan',
    progressByPhaseTitle: 'Progres per fase',
    targetFinishLabel: 'Target selesai {date}',
    keyDatesTitle: 'Tanggal penting',
    eventPhaseStarted: 'Fase {n} dimulai',
    eventPhaseDelivered: 'Fase {n} dikirim arsitek',
    eventPhaseApproved: 'Fase {n} disetujui klien',
    eventPhaseEstimated: 'Perkiraan Fase {n} selesai',
    noKeyDatesYet: 'Belum ada tanggal tercatat',
    noPhasesYet: 'Belum ada fase',
    openDeliverablesLink: 'Buka deliverable',
    approveEachDesc:
    ...
    tabPhases: 'Tahap & Deliverable',
    tabContract: 'Kontrak & Pembayaran',
    projectChatBtn: 'Obrolan Proyek',
    hideChatBtn: 'Sembunyikan Obrolan',
    needsActionLabel: 'Perlu tindakan Anda',
    nothingWaiting: 'Tidak ada yang menunggu Anda saat ini',
    allPhasesLink: 'Semua tahap',
    reviewCta: 'Tinjau',
    uploadCta: 'Unggah',
    ...
    colAction: 'Tindakan',
    colFiles: 'Berkas',
    approvedOf: '{approved} dari {total} disetujui',
    awaitingUpload: 'Menunggu unggahan',
    ...
    deliverableMissing: 'Belum dikirim',
    deliverableLocked: 'Terkunci',
    filesModalEyebrow: 'Berkas untuk deliverable',
    filesTaggedTo: '{n} berkas terkait deliverable ini \u00b7 {phase}',
    previewBtn: 'Pratinjau',
    contractLede:
      'Dana ditahan di escrow Rumantra dan dicairkan per tahap setelah Anda menyetujui pekerjaan.',
    colPhase: 'Tahap',
    colDeadline: 'Tenggat',
    colAmount: 'Jumlah',
    shareOfContract: '{share}% dari nilai kontrak',
    percentComplete: '{pct}% selesai',
    agreementTermsLabel: 'Ketentuan Perjanjian',
    termScope: 'Lingkup Pekerjaan',
    termFee: 'Dasar Biaya',
    termRevisions: 'Revisi',
    termTimeline: 'Linimasa',
    termIp: 'HKI & Gambar',
    termDispute: 'Penyelesaian Sengketa',
    termFeeValue: 'Biaya tetap, ditagih per tahap',
    termIpValue: 'Dialihkan ke klien saat pembayaran akhir',
    termDisputeValue: 'Ditinjau oleh dukungan Rumantra',
    termRevisionsValue: '{n} per tahap',
    termTimelineValue: '{n} hari',
    downloadPdfBtn: 'Unduh PDF',
    requestAmendmentBtn: 'Ajukan Perubahan',
    transactionHistoryLabel: 'Riwayat Transaksi',
    ...
    paidToDateLabel: 'Sudah dibayarkan',
    disbursedToYouLabel: 'Sudah dicairkan',
    heldInEscrowLabel: 'Dana diamankan',
    notYetFundedLabel: 'Belum didanai',
    createInvoiceInContract: 'Buat invoice di Kontrak & Pembayaran',
    payInContract: 'Bayar di Kontrak & Pembayaran',
    payoutInContract: 'Cairkan dana di Kontrak & Pembayaran',
    deliverablesAwaitingTitle: '{n} deliverable menunggu keputusan Anda',
    reviewDeliverablesCta: 'Tinjau deliverable',
    deliverablesUploadedCount: '{done} dari {total} deliverable terunggah',
    uploadAtLeastOne: 'Unggah minimal satu deliverable sebelum mengirim',
    deliverablesMissingCount: '{n} deliverable belum diunggah',
    notSubmittedYet: 'Sudah diunggah, belum dikirim \u2014 klien belum bisa meninjaunya',
    reuploadCta: 'Unggah ulang'
  },
  architectDashboard: {
    welcome: 'Selamat datang',
