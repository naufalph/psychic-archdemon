  ...
  public void logQuotaReset(Architect architect, BidQuota quota) {
    BidUsageLog log =
        BidUsageLog.builder()
            ...
            .quotaChange(quota.getTotalBidsAllowed())
            .quotaAfter(quota.getTotalBidsAllowed())
            .description(
                String.format(
  ...
  public void logQuotaUpgraded(Architect architect, Integer quotaAfter) {
    BidUsageLog log =
        BidUsageLog.builder()
            ...
            .quotaAfter(quotaAfter)
            .description(String.format("Upgraded to PREMIUM: quota reset to %d bids", quotaAfter))
            .timestamp(LocalDateTime.now())
            .build();
  ...
  public void logQuotaDowngraded(Architect architect, Integer quotaAfter) {
    BidUsageLog log =
        BidUsageLog.builder()
            ...
            .quotaChange(-quotaAfter)
            .quotaAfter(quotaAfter)
            .description(String.format("Downgraded to FREE: quota set to %d bids", quotaAfter))
            .timestamp(LocalDateTime.now())
            .build();
