<template>
  <!-- Modal Overlay -->
  <div v-if="isVisible" class="fixed inset-0 z-50 overflow-y-auto" @click.self="closeModal">
        ...
        <div v-if="currentView === 'signup'" class="w-full max-w-md mx-auto">
          <div class="text-left mb-8">
            ...
            <p class="body-small text-gray-600">
              ...
              <button @click="switchToSignIn" class="text-primary-600 hover:text-primary-700 font-medium">
                {{ $t('auth.signIn') }}
              </button>
            </p>
          </div>
          ...
          <div class="mt-6 text-left">
            <p class="text-xxs text-gray-500">
              ...
              <a href="#" class="text-primary-600 hover:text-primary-700"
                >{{ $t('auth.signup.termsAndPrivacy.terms') }}
              </a>
              {{ $t('auth.signup.termsAndPrivacy.and') }}
              <a href="#" class="text-primary-600 hover:text-primary-700">{{
                $t('auth.signup.termsAndPrivacy.privacy')
              }}</a>
            </p>
          </div>
        </div>
        ...
        <div v-else-if="currentView === 'emailSignup'" class="w-full max-w-md mx-auto">
          ...
          <form @submit.prevent="handleEmailSignup" class="space-y-4 pt-6">
            <div>
              ...
              />
              <p v-if="emailForm.errors.email" class="form-error mt-1 text-red-500 body-small">
            ...
            <div class="relative">
              ...
              <p v-if="emailForm.errors.password" class="form-error mt-1 text-red-500 body-small">
        ...
        <div v-else-if="currentView === 'signin'" class="w-full max-w-md mx-auto">
          <div class="text-left mb-8">
            ...
            <p class="body-small text-gray-600">
              ...
              <button @click="switchToSignup" class="text-primary-600 hover:text-primary-700 font-medium">
