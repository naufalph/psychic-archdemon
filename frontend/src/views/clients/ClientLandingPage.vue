        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            ...
            <div class="px-6 pb-6">
              ...
              <p class="text-body-medium font-body-regular font-inter text-gray-600 leading-relaxed">{{ $t(service.descriptionKey) }}</p>
            </div>
          </div>
        </div>

        <div class="text-left mt-6">
          <button class="bg-black text-white px-6 py-3 rounded-full text-button-medium font-button font-inter hover:bg-gray-800 transition-colors">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
          ...
          <p class="text-xl text-gray-600">
            Berbagai kategori desain sesuai kebutuhan Anda
          </p>
        </div>
...
export default {
  ...
  data() {
    return {
      ...
      categories: [
        { id: 1, name: 'Rumah Tinggal', count: 150, iconPath: 'M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6' },
        { id: 2, name: 'Apartemen', count: 89, iconPath: 'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4' },
        { id: 3, name: 'Kantor', count: 67, iconPath: 'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4' },
        { id: 4, name: 'Restoran', count: 45, iconPath: 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253' },
        { id: 5, name: 'Hotel', count: 32, iconPath: 'M8 14v3m4-3v3m4-3v3M3 21h18M3 10h18M3 7l9-4 9 4M4 10h16v11H4V10z' },
        { id: 6, name: 'Lainnya', count: 98, iconPath: 'M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 100 4m0-4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 100 4m0-4v2m0-6V4' }
      ],
      portfolios: [
        {
          id: 1,
