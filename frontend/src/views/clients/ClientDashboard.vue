        ...
        <div class="flex items-center justify-between">
          <div>
            <h2 class="text-xl font-semibold text-gray-900 mb-2">
              Selamat Datang di Rumantra
            </h2>
            <p class="text-gray-600">
              Platform terbaik untuk menemukan arsitek profesional untuk proyek impian Anda
            </p>
          </div>
        ...
        <div class="p-6">
          <div v-if="!isAuthenticated" class="text-center py-12">
            ...
            <p class="mt-1 text-sm text-gray-500">
              Daftar atau masuk untuk melihat proyek dan aktivitas terbaru Anda
            </p>
