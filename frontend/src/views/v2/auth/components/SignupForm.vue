<template>
  <div class="w-full max-w-[538px] bg-white rounded-2xl shadow-[0px_4px_4px_0px_rgba(0,0,0,0.3),0px_8px_12px_6px_rgba(0,0,0,0.15)] px-4 py-16">
    ...
    >
      <img
        src="@/assets/images/sign/back-sign.svg"
        alt="Go back"
        class="w-10 h-10"
      />
    </button>
    ...
    <!-- Title -->
    <h2 class="text-center font-poppins font-semibold text-4xl leading-[1.5em] text-black mb-6">
      Sign Up
    </h2>
...
const validateForm = () => {
  ...
  if (!formData.password) {
    ...
    errors.password = 'Password must contain at least one digit, one lowercase, one uppercase, and one special character'
    isValid = false
  }
