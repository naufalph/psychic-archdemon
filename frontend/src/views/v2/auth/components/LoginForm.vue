<template>
  ...
  >
    <!-- Title -->
    <h2 class="text-center font-poppins font-semibold text-4xl leading-[1.5em] text-[#C5A25A] mb-6">Login</h2>
    ...
    <form @submit.prevent="handleSubmit" class="space-y-6">
      ...
      <!-- Login Button -->
      <BaseButton type="submit" :loading="isSubmitting" block> Login </BaseButton>

      <!-- Sign Up Button -->
      <BaseButton type="button" variant="outline" block @click="handleSignUp"> Sign Up </BaseButton>
      ...
      <div class="space-y-4">
        <!-- Google Button -->
        <BaseButton type="button" variant="outline" block :disabled="isSubmitting" @click="handleGoogleLogin">
        ...
        <!-- LinkedIn Button -->
        <BaseButton type="button" variant="outline" block :disabled="isSubmitting" @click="handleLinkedInLogin">
          <div class="flex items-center justify-center gap-3">
